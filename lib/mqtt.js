    ...
    connect(options) {
        ...
        try {
            ...
            this.mqtt.on('connect', () => {
                ...
                self.options.io.map( o => {
                    if(o.mqtt.enabled == true){
                        if(o.mqtt?.subscribe?.data.length > 0){
                            this.mqtt.subscribe(o.mqtt?.subscribe?.data)
                        }
                        if(o.mqtt?.subscribe?.control.length > 0){
                            this.mqtt.subscribe(o.mqtt?.subscribe?.control)
                        }
                    }
                })
